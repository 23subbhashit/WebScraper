...
def rename(commodity,year,month) :
    os.rename('C:/Users/lenovo/Downloads/Agmarknet_State_wise_Wholesale_Prices_Monthly_Analysis.xls','C:/Users/Lenovo/Downloads/%s_%s_%s.xls'%(commodity,year,month))
    ...
    if values == '49' :
        ...
        for year in years_values :
            ...
            for month in month_values :
                if os.path.exists('C:/Users/Lenovo/Downloads/%s_%s_%s.xls'%(values,year,month)):
                    continue
                w=w+1
                if w!=1 :
                    select_commodity_option(values)
